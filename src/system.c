...
#pragma GCC diagnostic pop
    ...
    snprintf(config->g_ps2_ip, sizeof(config->g_ps2_ip), "%u.%u.%u.%u", local_ip_address[0], local_ip_address[1], local_ip_address[2], local_ip_address[3]);
    snprintf(config->g_ps2_netmask, sizeof(config->g_ps2_netmask), "%u.%u.%u.%u", local_netmask[0], local_netmask[1], local_netmask[2], local_netmask[3]);

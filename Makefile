...
# Path to gsKit (built via: cmake from https://github.com/ps2dev/gsKit)
GSKIT ?= $(CURDIR)/gsKit

# Host ps2-packer directory (must contain ps2-packer binary and .so packers)
PS2_PACKER_DIR ?= /tmp/ps2-packer-master
...
FRONTEND_OBJS = pad.o xparam.o fntsys.o renderman.o menusys.o OSDHistory.o system.o lang.o lang_internal.o config.o hdd.o dialogs.o \
		...
		appsupport.o gui.o guigame.o vmc_groups.o textures.o opl.o atlas.o nbns.o httpclient.o gsm.o cheatman.o sound.o ps2cnf.o animation.o
